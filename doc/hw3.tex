	      ...
	      \begin{soln}
		      \begin{center}
			      \begin{tabular}{c c c c}
				      \hline
				      Fold & Accuracy & Precision          & Recall             \\ \hline
				      1    & 0.908    & 0.8434163701067615 & 0.8315789473684211 \\
				      2    & 0.854    & 0.901840490797546  & 0.5306859205776173 \\
				      3    & 0.889    & 0.8215613382899628 & 0.778169014084507  \\
				      4    & 0.843    & 0.6634844868735084 & 0.9455782312925171 \\
				      5    & 0.849    & 0.7859778597785978 & 0.696078431372549  \\
				      \hline
			      \end{tabular}
		      \end{center}
	      \end{soln}
	...
	\item (10 pts) Run 5-fold cross validation with kNN varying k (k=1, 3, 5, 7, 10). Plot the average accuracy versus k, and list the average accuracy of each case. \\
	      ...
	      \begin{soln}
		      \begin{figure}[h]
			      ...
			      \small I implement two versions of the algorithm (q2-4.py and q2-4\_ski.py), and I give my algorithm the same interface with skilearn. My own implementation's result is slightly different from Skilearn's and the expected one.
		      \end{figure}
