	      ...
	      \begin{enumerate}
		      \item (6pts) Draw a ROC curve based on the above table.
		            ...
		            \begin{soln}
			            ...
			            \begin{figure}[h]
				            \centering
				            \includegraphics[width=0.7\textwidth,trim={0cm 0.2cm 0cm 0.2cm},clip]{../img/q1-5.png}
			            \end{figure}
		            \end{soln}
...
\begin{enumerate}
	\item (10 pts) Use the whole D2z.txt as training set.  Use Euclidean distance (i.e. $A=I$).
	      ...
	      \begin{soln}
		      \begin{figure}[h]
			      \centering
			      \includegraphics[width=0.7\textwidth]{../img/q2-1.png}
		      \end{figure}
	      \end{soln}
	      \pagebreak
	...
	\item (10 pts) Run 5-fold cross validation with kNN varying k (k=1, 3, 5, 7, 10). Plot the average accuracy versus k, and list the average accuracy of each case. \\
	      ...
	      \begin{soln}
		      \begin{figure}[h]
			      \centering
			      \includegraphics[width=0.7\textwidth]{../img/q2-4-ski.png}
			      \caption*{figure result from skilearn\textsuperscript{[1]}}
			      \small\textsuperscript{[1]} I used skilearn's result to draw this figure, and the result is slightly different from my own implementation. I do implement two versions of the algorithm (q2-4.py and q2-4\_ski.py), and I give my algorithm the same interface with skilearn, but it just run too slow. When I test the first fold, I get a same result from both algorithm, so I decide to put data from skilearn here.
		      \end{figure}
	...
	\item (10 pts) Use a single training/test setting. Train kNN (k=5) and logistic regression on the training set, and draw ROC curves based on the test set. \\
	      ...
	      \begin{soln}
		      ...
		      \begin{figure}[h!]
			      \centering
			      \includegraphics[width=0.7\textwidth]{../img/q2-5-ski.png}
		      \end{figure}
	      \end{soln}
